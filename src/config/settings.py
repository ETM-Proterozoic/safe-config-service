...
if READ_DOT_ENV_FILE:
    print("=== start to setting safe-config-service env ===")
    print(str(BASE_DIR.parent / DOT_ENV_FILE))
    env.read_env(str(BASE_DIR.parent / DOT_ENV_FILE))
...
CGW_URL = env("CGW_URL", default="")
CGW_FLUSH_TOKEN = env("CGW_FLUSH_TOKEN", default="")
